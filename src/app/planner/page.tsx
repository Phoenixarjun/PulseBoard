...
import { Mic, Plus, CheckCircle, Lightbulb, BrainCircuit, ArrowDown, ArrowRight } from 'lucide-react';
    ...
    <div className="flex-grow w-full max-w-[960px] mx-auto px-4 py-8 sm:px-6 relative pb-32">
      ...
      <section className="mb-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="text-xs text-blue-600 hover:text-blue-700 dark:hover:text-white transition-colors font-medium flex items-center gap-1">
            <Plus className="w-3 h-3" /> Add Outcome
          </button>
        </div>

        {/* Outcome Card 1 */}
        <div className="bg-white dark:bg-[#111318] border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden mb-6 transition-all hover:border-blue-600/40 group relative shadow-sm">
        ...
        {/* Outcome Card 2 (Empty State) */}
        <div className="bg-white dark:bg-[#111318] border border-slate-200 dark:border-slate-800 border-dashed rounded-xl overflow-hidden mb-6 opacity-60 hover:opacity-100 hover:border-solid hover:border-slate-300 dark:hover:border-slate-700 transition-all group shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-12 divide-y md:divide-y-0 md:divide-x divide-slate-200 dark:divide-slate-800">
            <div className="md:col-span-7 p-6">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-4 h-4 rounded-full border-2 border-slate-400 dark:border-slate-500"></div>
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">The Binary Proof</span>
              </div>
              <input
                type="text"
                className="w-full bg-transparent border-none p-0 text-slate-900 dark:text-white text-lg font-medium placeholder-slate-400 dark:placeholder-slate-600 focus:ring-0"
            ...
            <div className="md:col-span-5 p-6 bg-slate-50 dark:bg-white/[0.01]">
              <div className="flex items-center gap-2 mb-3">
                <Lightbulb className="text-slate-400 dark:text-slate-600 w-4 h-4" />
                <span className="text-xs font-bold text-slate-500 dark:text-slate-600 uppercase tracking-wider">Strategic Value</span>
              </div>
              <p className="text-sm text-slate-400 dark:text-slate-600 italic">Describe the impact...</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[960px] mx-auto pointer-events-auto">
          <div className="flex items-center justify-between gap-4 bg-white dark:bg-[#1a1e29] border border-slate-200 dark:border-slate-800 p-3 rounded-2xl shadow-xl dark:shadow-2xl shadow-slate-200/50 dark:shadow-black/50">
            <div className="hidden sm:flex items-center gap-4 px-3">
              <div className="flex flex-col">
                ...
                <div className="flex gap-1 mt-1">
                  ...
                  <div className="w-8 h-1 bg-blue-600/30 rounded-full"></div>
                  <div className="w-8 h-1 bg-slate-200 dark:bg-slate-800 rounded-full"></div>
                </div>
              </div>
              <div className="h-6 w-px bg-slate-200 dark:bg-slate-800"></div>
              <p className="text-xs text-slate-500 dark:text-slate-400">2 Outcomes drafted</p>
            </div>
            <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
              ...
              <button className="px-6 py-2.5 rounded-xl text-sm font-bold bg-blue-600 hover:bg-blue-700 text-white shadow-[0_0_20px_rgba(25,93,230,0.4)] hover:shadow-[0_0_25px_rgba(25,93,230,0.6)] transition-all flex items-center gap-2">
